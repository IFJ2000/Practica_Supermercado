...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $temp_nombre = depurar($_POST[Constantes_vista::NOMBRE]);
        $temp_precio = depurar($_POST[Constantes_vista::PRECIO]);
        $temp_descripcion = depurar($_POST[Constantes_vista::DESCRIPCION]);
        $temp_cantidad = depurar($_POST[Constantes_vista::CANTIDAD]);
